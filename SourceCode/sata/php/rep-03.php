<?php
	...
	$hirarchy = "rep-03_{$level}_{$zone}_{$sar}_{$br}_{$aghd}_{$fasl}_{$year}{$moon}";
	...
	if($level == "zone")
	{
		if($zone == -1)
		{
			...
			{
				$newline = array(
					array("جزییات عقود", "{report:\"rep-03\", level:\"zone\", sar:{$sar}, br:{$br}, year:{$year}, moon:{$moon}, zone:".odbc_result($result, "ZONCODE").", aghd:1}"),
					array("ادارات امور", "{report:\"rep-03\", level:\"zone\", sar:{$sar}, br:{$br}, year:{$year}, moon:{$moon}, zone:".odbc_result($result, "ZONCODE").", aghd:0}"),
		...
		else
		{
			if($aghd == 0)
			{
				if($sar == -1)
				{
					...
					{
						$newline = array(
							array("مشاهده عقود", "{report:\"rep-03\", level:\"zone\", sar:".odbc_result($result, "SAR").", br:{$br}, year:{$year}, moon:{$moon}, zone:{$zone}, aghd:1}"),
							array("نمایش شعب", "{report:\"rep-03\", level:\"zone\", sar:".odbc_result($result, "SAR").", br:{$br}, year:{$year}, moon:{$moon}, zone:{$zone}, aghd:0}"),
				...
				else
				{
						...
						{
							$newline = array(
								array("مشاهده عقود", "{report:\"rep-03\", level:\"zone\", sar:{$sar}, br:".odbc_result($result, "BR").", year:{$year}, moon:{$moon}, zone:{$zone}, aghd:1}"),
			...
			else /* */
			{
				if($sar == -1)
				{
					if($fasl == 0)
					{
						...
						{
							$newline = array(
								array("سرفصلها", "{report:\"rep-03\", level:\"zone\", sar:{$sar}, br:{$br}, year:{$year}, moon:{$moon}, zone:{$zone}, aghd:".odbc_result($result, "INDX").", fasl:1}"),
	...
	else
	{
		if($sar == -1)
		{
			if($aghd == 0)
			{
				...
				{
					$newline = array(
						array("سرفصلها","{report:\"rep-03\", level:\"sar\", year:{$year}, moon:{$moon}, aghd:".odbc_result($result, "INDX")."}"),
						iconv('UTF-8', 'UTF-8//IGNORE', trim(odbc_result($result, "DESCRIPTION"))), 
						odbc_result($result, "AMOUNT01"), 
						odbc_result($result, "AMOUNT02"), 
						odbc_result($result, "AMOUNT03"), 
		...
		elseif($br == -1)
		{
			if($aghd == 0)
			{
				...
				{
					$newline = array(
						array("سرفصلها", "{report:\"rep-03\", level:\"sar\", sar:{$sar}, year:{$year}, moon:{$moon}, aghd:".odbc_result($result, "INDX")."}"),
						iconv('UTF-8', 'UTF-8//IGNORE', trim(odbc_result($result, "DESCRIPTION"))), 
						odbc_result($result, "AMOUNT01"), 
						odbc_result($result, "AMOUNT02"), 
						odbc_result($result, "AMOUNT03"), 
		...
		else
		{
			...
			if($aghd == 0)
			{
				...
				{
					$newline = array(
						array("مشاهده جزییات", "{report:\"rep-03\", level:\"sar\", sar:{$sar}, br:{$br}, year:{$year}, moon:{$moon}, aghd:".odbc_result($result, "INDX")."}"),
						iconv('UTF-8', 'UTF-8//IGNORE', trim(odbc_result($result, "DESCRIPTION"))), 
						odbc_result($result, "AMOUNT01"), 
						odbc_result($result, "AMOUNT02"), 
						odbc_result($result, "AMOUNT03"), 
