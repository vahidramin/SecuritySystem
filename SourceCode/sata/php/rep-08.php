<?php
	...
	$hirarchy = "rep-08_{$level}_{$zone}_{$sar}_{$br}_{$aghd}_{$fasl}_{$year}{$moon}";
	...
	if($sar == -1)
	{
		...
		while(odbc_fetch_row($result))
		{
			...
			$newline = array(
				"type" => false,
				array("نمایش شعب", "{report:\"rep-08\", level:\"zone\", sar:".odbc_result($result, "SAR").", br:{$br}, year:{$year}, moon:{$moon}, zone:".odbc_result($result, "ZONECODE").", aghd:0}"),
